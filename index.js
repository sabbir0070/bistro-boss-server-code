...
// middleware: use verifyJWT before using verifyAdmin
...
// donot show secure links to thoses who should see the links
// user verify admin jwt
...
const pipeline = [
     {
      ...
      { $unwind: '$menuItemsData' }, // Deconstruct the "menuItemsData" array
      {
        $group: {
...
app.get('/', (req, res) => {
  res.send('bistro boss server is sitting running')
})
